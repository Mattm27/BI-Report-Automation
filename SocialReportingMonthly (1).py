...
<ul>
    <li>Fox News <strong>ranked #""" + human_format(Fox_Rank['Rank'].iloc[0]) + """ against the competitive set for """ + date['Date'].iloc[1]+ """ """ + str((date['Date'].iloc[0])) + """ driving in """ + human_format(Fox_Rank['Total Interactions'].iloc[0]) + """ total interactions</strong> (Facebook, Instagram, Twitter combined)<ul>  
            <li>Overall social interactions were """ + up_down(MonthlyTotal['Yearly'].iloc[0]) + """ """ + MonthlyTotal['Yearly'].iloc[0] + """ vs. prior year """ + check_up_down(up_down(MonthlyTotal['Yearly'].iloc[0]),up_down(MonthlyTotal['Monthly'].iloc[0])) + up_down(MonthlyTotal['Monthly'].iloc[0]) + """ """ + MonthlyTotal['Monthly'].iloc[0] + """ vs. prior month.</li>
        </ul>
    </li>
    <li>Fox News ranked <strong> #""" + human_format(Fox_Rank1['Rank1'].iloc[0]) + """ in social engagement on facebook</strong>, <strong>#""" + human_format(Fox_Rank2['Rank2'].iloc[0]) + """ on Instagram</strong>, and <strong> #""" + human_format(Fox_Rank3['Rank3'].iloc[0]) + """ on twitter</strong> amongst the competitive set<ul>
            <li>Fox News drove in """ + human_format(Fox_Rank1['Facebook Interactions'].iloc[0]) + """ Facebook interactions, """ + up_down(MonthlyTotal1['Yearly1'].iloc[0]) + """ """ + MonthlyTotal1['Yearly1'].iloc[0] + """ vs. prior year """ + check_up_down(up_down(MonthlyTotal1['Yearly1'].iloc[0]),up_down(MonthlyTotal1['Monthly1'].iloc[0])) + up_down(MonthlyTotal1['Monthly1'].iloc[0])+ """ """ + MonthlyTotal1['Monthly1'].iloc[0] + """ vs. prior month</li>
            <li>Fox News drove in """ + human_format(Fox_Rank2['Instagram Interactions'].iloc[0]) + """ Instagram interactions, """ + up_down(MonthlyTotal2['Yearly2'].iloc[0]) + """ """ + MonthlyTotal2['Yearly2'].iloc[0] + """ vs. prior year """+ check_up_down(up_down(MonthlyTotal2['Yearly2'].iloc[0]),up_down(MonthlyTotal2['Monthly2'].iloc[0])) + up_down(MonthlyTotal2['Monthly2'].iloc[0])+ """ """ + MonthlyTotal2['Monthly2'].iloc[0] + """ vs. prior month</li>
            <li>Fox News drove in """ + human_format(Fox_Rank3['Twitter Interactions'].iloc[0]) + """ Twitter interactions, """ + up_down(MonthlyTotal3['Yearly3'].iloc[0]) + """ """ + MonthlyTotal3['Yearly3'].iloc[0] + """ vs. prior year  """ + check_up_down(up_down(MonthlyTotal3['Yearly3'].iloc[0]),up_down(MonthlyTotal3['Monthly3'].iloc[0])) + up_down(MonthlyTotal3['Monthly3'].iloc[0])+ """ """ + MonthlyTotal3['Monthly3'].iloc[0] + """ vs. prior month</li>
        </ul>
    </li>
    <li>Fox News ranked  <strong> #""" + human_format(Fox_Rank4['Rank4'].iloc[0]) + """ in youtube views amongst the News competitive set </strong> <ul>
            <li>Fox News drove in """ + human_format(Fox_Rank4['Youtube Views'].iloc[0]) + """ YouTube Views, """ + up_down(MonthlyTotal4['Yearly4'].iloc[0]) + """ """ + MonthlyTotal4['Yearly4'].iloc[0] + """ vs. prior year """ + check_up_down(up_down(MonthlyTotal4['Yearly4'].iloc[0]),up_down(MonthlyTotal4['Monthly4'].iloc[0])) + up_down(MonthlyTotal4['Monthly4'].iloc[0]) + """ """ + MonthlyTotal4['Monthly4'].iloc[0] + """ vs. prior month</li>
        </ul>
    </li>
</ul>
...
<ul>
    <li>Fox Business ranked <strong> #""" + human_format(Fox_Rank5['Rank5'].iloc[0]) + """ against the competitive set for """ + date['Date'].iloc[1] + """ """ + str((date['Date'].iloc[0])) + """, driving in """ + human_format(Fox_Rank5['Business Total Interactions'].iloc[0]) + """ total social interactions </strong>(Facebook, Instagram, Twitter combined)<ul>
            <li>Overall social interactions were """ + up_down(MonthlyTotal5['Yearly5'].iloc[0]) + """ """ + MonthlyTotal5['Yearly5'].iloc[0] + """ vs. prior year """ + check_up_down(up_down(MonthlyTotal5['Yearly5'].iloc[0]),up_down(MonthlyTotal5['Monthly5'].iloc[0])) + up_down(MonthlyTotal5['Monthly5'].iloc[0]) + """ """ + MonthlyTotal5['Monthly5'].iloc[0] + """ vs. prior month</li>
        </ul>
    </li>
    <li>Fox Business ranked <strong> #""" + human_format(Fox_Rank6['Rank6'].iloc[0]) + """ in social engagement on Facebook</strong>
        <ul>
            <li>Overall drove in """ + human_format(Fox_Rank6['Business Facebook Interactions'].iloc[0]) + """ interactions and were """ + up_down(MonthlyTotal6['Yearly6'].iloc[0]) + """ """ + MonthlyTotal6['Yearly6'].iloc[0] + """ vs. prior year """ + check_up_down(up_down(MonthlyTotal6['Yearly6'].iloc[0]),up_down(MonthlyTotal6['Monthly6'].iloc[0])) + up_down(MonthlyTotal6['Monthly6'].iloc[0]) + """ """ + MonthlyTotal6['Monthly6'].iloc[0] + """ vs. prior month</li>
        </ul>
    </li>
    <li>Fox Business ranked<strong>&nbsp;</strong><strong> #""" + human_format(Fox_Rank7['Rank7'].iloc[0]) + """ in social engagement on Instagram</strong>
        <ul>
            <li>Overall drove in """ + human_format(Fox_Rank7['Business Instagram Interactions'].iloc[0]) + """ interactions and were """ + up_down(MonthlyTotal7['Yearly7'].iloc[0]) + """ """ + MonthlyTotal7['Yearly7'].iloc[0] + """ vs. prior year """ + check_up_down(up_down(MonthlyTotal7['Yearly7'].iloc[0]),up_down(MonthlyTotal7['Monthly7'].iloc[0])) + up_down(MonthlyTotal7['Monthly7'].iloc[0]) + """ """ + MonthlyTotal7['Monthly7'].iloc[0] + """ vs. prior month</li>
        </ul>
    </li>
    <li>Fox Business ranked <strong>#""" + human_format(Fox_Rank9['Rank9'].iloc[0]) + """ in Youtube views</strong> against competitors, driving in """ + human_format(Fox_Rank9['Business Youtube Views'].iloc[0]) + """ video views (Source: Shareablee) &nbsp;<ul>
            <li>On Youtube, Fox Business video views were """ + up_down(MonthlyTotal9['Yearly9'].iloc[0]) + """ """ + MonthlyTotal9['Yearly9'].iloc[0] + """ vs. prior year """ + check_up_down(up_down(MonthlyTotal9['Yearly9'].iloc[0]),up_down(MonthlyTotal9['Monthly9'].iloc[0])) + up_down(MonthlyTotal9['Monthly9'].iloc[0]) + """ """ + MonthlyTotal9['Monthly9'].iloc[0] + """ vs. prior month</li>
        </ul>
    </li>
</ul>
"""
...
# Test HTML Page
# Function_Name = open("GFG-2.html","w")
